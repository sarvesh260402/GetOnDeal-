<!-- FOOTER -->
<footer class="bg-white pt-20 pb-10 border-t border-[#E6EAF0]">
    <div class="max-w-7xl mx-auto px-5 sm:px-8">
        <!-- Newsletter -->
        <div class="bg-[#0B0B12] rounded-[2rem] p-8 sm:p-12 mb-20 flex flex-col lg:flex-row items-center justify-between gap-8">
            <div class="max-w-md text-center lg:text-left">
                <h3 class="font-display text-3xl font-extrabold text-white">Join the inner circle.</h3>
                <p class="text-white/60 mt-2">Get early access to exclusive deals and member-only experiences.</p>
            </div>
            <form class="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
                <input type="email" placeholder="Your email address" class="bg-white/10 border border-white/20 rounded-full px-6 py-4 text-white outline-none focus:border-[#F7931E] transition-colors min-w-[300px]">
            ...
            <div class="col-span-2 lg:col-span-4">
                <a href="index.php" class="flex items-center gap-2 mb-6" aria-label="GetOnDeal Home">
                    <div class="flex items-center">
                        ...
                        <span style="color:#0F4C81;font-weight:800;font-size:28px;line-height:1;letter-spacing:-0.04em;">nDeal</span>
                    </div>
                </a>
                <p class="text-[#5B6271] text-sm leading-relaxed mb-8 max-w-sm">
                    Mumbai's premier discovery and booking platform. Handpicked venues, verified deals, and a community of people who love to explore.
                </p>
                <div class="space-y-3">
